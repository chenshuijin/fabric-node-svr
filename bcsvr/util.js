...
module.exports.END2END = {
	channel: config['test-network'].channelID,
	chaincodeId: config['test-network'].chaincodeId,
	chaincodeVersion: config['test-network'].chaincodeVersion
};

// directory for file based KeyValueStore
module.exports.KVS = config['test-network'].keyValueStore;
...
module.exports.getSubmitter = function(uname, upwd, client, org) {
	...
	return getSubmitter(uname, upwd, client, fromConfig, userOrg);
};
